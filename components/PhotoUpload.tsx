  ...
  return (
    <div className="w-full group">
      <label
        ...
        className="flex flex-col items-center justify-center w-full h-48 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer bg-gray-50 group-hover:bg-pink-50 group-hover:border-pink-300 transition-all duration-200"
      >
